...
public class ChinhSuaBaiKiemTra extends AppCompatActivity {
    ...
    private void eventClickListenner() {
        ...
        hinh.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ImagePicker.with(ChinhSuaBaiKiemTra.this)
                        .crop()
                        .compress(1204)
        ...
        baiKt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), QuanLyBKT_TracNghiem.class);
                intent.putExtra("baiKiemTraCS", baiKiemTra);
    ...
    private void chinhSuaBaiKiemTra() {
        ...
        if (TextUtils.isEmpty(str_linkAnh)) {
            ...
            try {
                ...
                compositeDisposable.add(apiHocTap.capnhatBaiKiemTraAPI(str_tenBai, str_linkAnh, thoiLuongInt, mabaikiemtra)
    ...
    private void getDuLieuBaiKiemTra() {
        baiKiemTra = (BaiKiemTra) getIntent().getSerializableExtra("baiKiemTraAdapter");

        linkAnh.setText("" + baiKiemTra.getHinhanhminhhoa());
        tenBai.setText("" + baiKiemTra.getTenbaikiemtra());
        thoiLuong.setText("" + baiKiemTra.getThoiluong());

        // load ảnh cho bài kiểm tra
    ...
    private void anhXa() {
        linkAnh = findViewById(R.id.linkAvtBaiKiemTra_CSBKT);
        tenBai = findViewById(R.id.tenBaiKiemTra_CSBKT);
        thoiLuong = findViewById(R.id.thoiLuongBaiKiemTra_CSBKT);
        hinh = findViewById(R.id.pickAnhbaiKT_CSBKT);
        editBtn = findViewById(R.id.editBaiKiemtra_CSBKT);
        back = findViewById(R.id.backBtn_CSBKT);
        baiKt = findViewById(R.id.quanLyBaiKiemTra);
    }
    ...
    private void initGiaoDien() {
        ...
        setContentView(R.layout.activity_chinh_sua_bai_kiem_tra);
